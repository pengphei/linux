...
static enum power_supply_usb_type bq25700_usb_types[] = {
...
static const struct power_supply_desc bq25700_power_supply_desc = {
	...
	.usb_types = bq25700_usb_types,
	.num_usb_types = ARRAY_SIZE(bq25700_usb_types),
...
static void bq25700_host_evt_worker(struct work_struct *work)
{
	...
	if(!extcon_get_property(edev, EXTCON_USB_HOST,
				    EXTCON_PROP_USB_VBUS, &val))
	{
		if(1 == val.intval) {
